...
/**
 * Check if a given object implements the WorkItemDetail interface.
 */
export function instanceOfWorkItemDetail(value: object): value is WorkItemDetail {
...
export function WorkItemDetailFromJSON(json: any): WorkItemDetail {
    return WorkItemDetailFromJSONTyped(json, false);
}

export function WorkItemDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkItemDetail {
    if (json == null) {
        return json;
    }
    return {
...
export function WorkItemDetailToJSON(json: any): WorkItemDetail {
